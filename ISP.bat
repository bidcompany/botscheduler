...
xcopy /Y %~dp0\ISP\campaigns.json E:\tmp\A\SASCampaignNavigator\bin\campaigns.json

echo 'Refresh session files for the new execution in ISP'
REM if exist E:\tmp\A\SASCampaignNavigator\bin\campaigns.json del /F E:\tmp\A\SASCampaignNavigator\bin\campaigns.json
